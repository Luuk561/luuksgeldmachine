...
class InitialDataImport extends Command
{
    ...
    public function handle(): int
    {
        ...
        $this->info("📥 Step 1/4: Importing {$days} days of raw data from APIs...");
        ...
        $this->info('📊 Step 3/4: Aggregating metrics (all periods)...');
